(() => {
  ...
  function hideOrganizerLinks() {
    ...
    const orgLinks = document.querySelectorAll('li a[href="organizer.html"]');
    if (type !== "organizer") {
  ...
  function hideUserLinks() {
    const type = localStorage.getItem("userType");
    if (type === "organizer") {
      const userLinks = document.querySelectorAll('li a[href="dashboard.html"]');
  ...
  window.tp.updateLogoLink = updateLogoLink;
